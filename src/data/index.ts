    ...
    ranks: [
      {
        ...
        description: "El primer paso hacia el vacío. Los Ender empiezan a escuchar la llamada del Núcleo.",
        price: null,
        benefits: ["Prefijo exclusivo en el chat", "Protección extra de terrenos", "Kit de inicio de temporada"],
      },
      {
        name: "Shadow",
        color: "#FFC200",
        ...
        description: "Los que cazan en la oscuridad. Se ganan el respeto del vacío con horas de juego.",
        price: null,
        benefits: ["Prefijo exclusivo en el chat", "Efecto de partículas al entrar", "Sethome adicional"],
      },
      {
        name: "Noctis",
        color: "#FC9411",
        ...
        description: "Los que atraviesan la noche. El calor del núcleo empieza a correr por sus venas.",
        price: null,
        benefits: ["Prefijo exclusivo en el chat", "Hat cosmético de temporada", "Prioridad en colas"],
      },
      {
        name: "Nexus",
        color: "#F8356F",
        ...
        description: "El centro de todo. Los Nexus conectan dimensiones, alianzas y destinos.",
        price: null,
        benefits: ["Prefijo exclusivo en el chat", "Tag animado", "Acceso a zonas exclusivas"],
      },
      {
        name: "Abyss",
        color: "#F93636",
        ...
        description: "Los que han mirado el fondo del vacío y han vuelto. Rango reservado a leyendas de la temporada.",
        price: null,
        benefits: ["Prefijo exclusivo en el chat", "Cosméticos exclusivos del End", "Participación en eventos privados"],
      },
      {
        name: "Vyper",
        color: "#1A50FC",
        ...
        description: "Rapidez y precisión. Los Vyper son la élite competitiva de AstralixMC.",
        price: null,
        benefits: ["Prefijo exclusivo en el chat", "Efecto de estela al moverse", "Voto en decisiones del lore"],
      },
      {
        name: "Vyper+",
        color: "#9A1DFC",
        ...
        description: "La cima de la progresión: reservado a los que dominan todas las facetas del servidor.",
        price: null,
        benefits: ["Prefijo exclusivo en el chat", "Todos los cosméticos del End", "Kit de temporada élite"],
      },
    ],
  },
];
